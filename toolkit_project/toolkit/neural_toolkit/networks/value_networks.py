...
This module provides flexible value network implementations for state-value and action-value estimation.
Supports various architectures including MLP, CNN, RNN, and Transformer-based value networks.
"""
...
class BaseValueNetwork(nn.Module, ABC):
    """Base class for all value networks"""
...
class CNNValueNetwork(BaseValueNetwork):
    """Convolutional Neural Network Value Network for image-based observations"""
...
class RNNValueNetwork(BaseValueNetwork):
    """Recurrent Neural Network Value Network for sequential observations"""
...
class TransformerValueNetwork(BaseValueNetwork):
    """Transformer-based Value Network for complex sequential patterns"""
...
class ValueFactory:
    ...
    def create_value_network(network_type: str, **kwargs) -> BaseValueNetwork:
        """Create a value network based on type"""
        network_types = {
            'mlp': MLPValueNetwork,
            'cnn': CNNValueNetwork,
            'rnn': RNNValueNetwork,
...
if __name__ == "__main__":
    ...
    # Test RNN Value Network
    rnn_value = ValueFactory.create_value_network(
        network_type='rnn',
        input_dim=10,
        output_dim=1,
        hidden_dim=256,
    ...
    print("All value networks created successfully!") 